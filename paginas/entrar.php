...
<div class="formEntrar">
    <h2 class="text-center">Efetue seu Login</h2>
    ...
    <div>
        <form class="">
            ...
            <a href="?pagina=home" type="submit" class="btn btn-darken ">Entrar</a>

        </form>
        <div class="dropdown-divider mb-3"></div>
        <a class="textLinks" href="?pagina=cadastro"><p>É novo por aqui? Cadastre-se</p></a>
        <a class="textLinks" href="?pagina=resetsenha"><p>Esqueceu sua senha?</p></a>
    </div>
